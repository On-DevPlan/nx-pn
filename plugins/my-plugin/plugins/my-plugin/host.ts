 ...
 *      shows a record on /audit attributed to my-plugin.
 *   3. Registers one tool endpoint your browser half can call via
 *      ctx.hostCall.hostCall('my-plugin/boot-count', {}) — see browser.tsx.
 *
