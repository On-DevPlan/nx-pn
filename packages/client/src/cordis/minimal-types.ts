/**
 * Minimal structural types for the slice of cordis that packages/client
 ...
 *
 * A verbatim copy of packages/host/src/cordis/minimal-types.ts — the
 * browser runtime consumes the same cordis release.
 */
