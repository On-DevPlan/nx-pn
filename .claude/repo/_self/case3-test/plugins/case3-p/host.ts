 ...
 *      shows a record on /audit attributed to case3-p.
 *   3. Registers one tool endpoint your browser half can call via
 *      ctx.hostCall.hostCall('case3-p/boot-count', {}) — see browser.tsx.
 *
